...
export default function Register() {
  ...
  const Postdata = async (e) => {
    ...
    const { name, email, phone, location, spokenLanguages, availability } =
      user;

    const res = await fetch("https://teachforindiavolun.herokuapp.com/", {
      method: "POST",
      headers: {
        ...
        >
          <Stack spacing={4}>
            ...
            <Text color={"gray.500"} fontSize={{ base: "sm", sm: "md" }}>
              We’re looking for amazing volunteers just like you! Become a part
